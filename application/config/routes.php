...
$route['case-studies-03'] = 'Service/index';
$route['case-studies-04'] = 'Service/index';
...
$route['shopkart/products/create-payment-link'] = 'admin/Products/create_razorpay_payment_link';
$route['admin/products/create_razorpay_payment_link'] = 'admin/Products/create_razorpay_payment_link';
// Inventory
...
$route['shopkart/saas-billing'] = 'admin/Saas_billing/index';
$route['shopkart/saas-billing/daily'] = 'admin/Saas_billing/daily';
$route['shopkart/saas-billing/requests'] = 'admin/Saas_billing/requests';
$route['shopkart/saas-billing/requests/view/(:any)'] = 'admin/Saas_billing/request_view/$1';
$route['shopkart/saas-billing/amounts'] = 'admin/Saas_billing/amounts';
$route['shopkart/saas-billing/amounts/save'] = 'admin/Saas_billing/amount_save';
$route['shopkart/saas-billing/amounts/delete/(:num)'] = 'admin/Saas_billing/amount_delete/$1';
$route['shopkart/saas-billing/run_job'] = 'admin/Saas_billing/run_job';
$route['admin/saas-billing'] = 'admin/Saas_billing/index';
$route['admin/saas-billing/daily'] = 'admin/Saas_billing/daily';
$route['admin/saas-billing/requests'] = 'admin/Saas_billing/requests';
$route['admin/saas-billing/requests/view/(:any)'] = 'admin/Saas_billing/request_view/$1';
$route['admin/saas-billing/amounts'] = 'admin/Saas_billing/amounts';
$route['admin/saas-billing/amounts/save'] = 'admin/Saas_billing/amount_save';
$route['admin/saas-billing/amounts/delete/(:num)'] = 'admin/Saas_billing/amount_delete/$1';
$route['admin/saas-billing/run_job'] = 'admin/Saas_billing/run_job';
$route['cron/saas_daily_bills'] = 'Cron/saas_daily_bills';
$route['shopkart-api/saas/ai-requests']['POST'] = 'api/Sk_Saas_Billing/ai_requests';
$route['api/saas/ai-requests']['POST'] = 'api/Sk_Saas_Billing/ai_requests';
...
$route['shopkart/settings/run_sql'] = 'admin/Settings/run_sql';
$route['admin/meta'] = 'admin/Meta/index';
$route['admin/meta/connect'] = 'admin/Meta/connect';
...
$route['admin/whatsapp_requests/vendor_exchange'] = 'admin/Whatsapp_requests/vendor_exchange';
$route['admin/whatsapp_requests/vendor_set_default'] = 'admin/Whatsapp_requests/vendor_set_default';
$route['admin/whatsapp_requests/vendor_set_status'] = 'admin/Whatsapp_requests/vendor_set_status';
$route['admin/whatsapp_requests/pending'] = 'admin/Whatsapp_requests/pending';
$route['admin/whatsapp_requests/exchange'] = 'admin/Whatsapp_requests/exchange';
$route['admin/whatsapp_requests/approve/(:num)'] = 'admin/Whatsapp_requests/approve/$1';
$route['admin/whatsapp_requests/reject/(:num)'] = 'admin/Whatsapp_requests/reject/$1';
$route['admin/whatsapp_requests/set_account_status/(:num)'] = 'admin/Whatsapp_requests/set_account_status/$1';
$route['shopkart/whatsapp_requests'] = 'admin/Whatsapp_requests/index';
$route['shopkart/whatsapp_requests/submit'] = 'admin/Whatsapp_requests/submit';
$route['shopkart/whatsapp_requests/vendor_exchange'] = 'admin/Whatsapp_requests/vendor_exchange';
$route['shopkart/whatsapp_requests/vendor_set_default'] = 'admin/Whatsapp_requests/vendor_set_default';
$route['shopkart/whatsapp_requests/vendor_set_status'] = 'admin/Whatsapp_requests/vendor_set_status';
$route['shopkart/whatsapp_requests/pending'] = 'admin/Whatsapp_requests/pending';
$route['shopkart/whatsapp_requests/exchange'] = 'admin/Whatsapp_requests/exchange';
$route['shopkart/whatsapp_requests/approve/(:num)'] = 'admin/Whatsapp_requests/approve/$1';
$route['shopkart/whatsapp_requests/reject/(:num)'] = 'admin/Whatsapp_requests/reject/$1';
...
$route['admin/settings/run_sql'] = 'admin/Settings/run_sql';
...
$route['shopkart-api/products/offers']['GET'] = 'api/Sk_Product/offers';
$route['shopkart-api/products/combo-offers']['GET'] = 'api/Sk_Product/combo_offers';
